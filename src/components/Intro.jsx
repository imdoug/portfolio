...
const Intro = () =>{
    ...
    return(
        ...
        <div className="nav-text">
            ...
            <nav className="lower"><p> you can also check some of my <a href="#PROJECTS">PROJECTS</a> and download my <a href="https://drive.google.com/file/d/1kMCy_Vbk3-9CWjzZtf6Jss_-xR3dpWYc/view?usp=sharing" target="_blank">RESUME</a></p></nav>
