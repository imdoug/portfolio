...
const Intro = () =>{
    ...
    return(
        ...
        <div className="nav-text">
            ...
            <nav className="lower"><p> you can also check some of my <a href="#PROJECTS">PROJECTS</a> and download my <a href="https://drive.google.com/file/d/1Le82QA0wfC7HFOv4UjQD6iibP0egNFKF/view?usp=sharing" target="_blank">RESUME</a></p></nav>
