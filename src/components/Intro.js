...
const Intro = () =>{
    ...
    return(
        ...
        <div className="nav-text">
            ...
            <nav className="lower"><p> you can also check some of my <a href="#PROJECTS">PROJECTS</a> and download my <a href="https://docs.google.com/document/d/1Vv2TkEeLTIMgR_-B00EY-gJRoxnZaEPnY-DEnJAKDq4/edit?usp=sharing" target="_blank" rel="noreferrer">RESUME</a></p></nav>
